...
--cfg-path lavis/projects/blip2/train/aokvqa_ft_flant5xl_select.yaml \
--options run.output_dir="output/blip2_flant5xl/AOKVQA_select_lora/train_cycle_select_bs8_lr1e-4_k30_10" \
model.knowledge_num=10 \
model.use_lora=True \
