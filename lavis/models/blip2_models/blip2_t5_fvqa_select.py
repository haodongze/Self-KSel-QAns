...
@registry.register_model("blip2_t5_fvqa_select")
class Blip2T5_fvqa_select(Blip2Base):
    """
    BLIP2 T5 model.
    ...
    def from_config(cls, cfg):
        ...
        # url_or_filename = "/public/dzhao/blip2_vqa/lavis/output/blip2_flant5xl/OKVQA_select_lora/train_cycle_select_bs8_lr1e-4_k5_1_caption/20240411162/checkpoint_best.pth"
